        ...
        let promise = new Promise(async (resolve)=>{
            ...
            const controls = {
                ...
                <div class='mermaid-controls'>
                    <button class='mermaid-button' data-action='zoom-in' aria-label='Zoom in'><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class='mermaid-button' data-action='reset-zoom' araia-label='Reset zoom'><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class='mermaid-button' data-action='zoom-out' aria-label='Zoom out'><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
