...
export const makeHeader = (filename) => {
   ...
   const actionButtonsWrapper = {
    ...
    children: [{
        type: 'html',
        value: `<button data-action='copy' aria-label='Copy code to clipboard'><svg width="20" height="20" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            type: 'html',
            value: `<button aria-label='Download code' data-action='download'><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
