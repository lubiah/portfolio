...
export const makeHeader = (filename) => {
   ...
   const actionButtonsWrapper = {
    ...
    children: [{
        type: 'html',
        value: `<button data-action='copy'><svg width="20" height="20" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            type: 'html',
            value: `<button data-action='download'><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
